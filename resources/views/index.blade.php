<x-app-layout>
    ...
    <div class="my-6 space-y-6 ideas-container">
        <div class="flex transition duration-150 ease-in bg-white idea-container hover:shadow-md rounded-xl">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button class="relative px-3 py-1 leading-loose text-gray-400 transition duration-150 ease-in bg-gray-100 rounded-full pb-7 hover:bg-gray-200 h-7">
                                ...
                                <ul class="absolute py-3 ml-8 font-semibold text-left bg-white shadow-lg w-44 rounded-xl">
                                    <li>
